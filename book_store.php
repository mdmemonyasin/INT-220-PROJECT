		...
		<nav class="navbar navbar-default">
  			<div class="container-fluid">
				    ...
				    <ul class="nav navbar-nav">
				      ...
				      <li class="active"><a href="book_store.php">Book Details</a></li>
		...
		foreach ($result as $value) {
			...
			echo "
				<div class='col-md-4 img responsive'>
					<img src='$img' class='book img-responsive'/>
...
<div class="footer">
	<div class="row">
		<div class="col-md-12">
			<h2 class="footer-head">&copy; 2020 Library Mangement System</h2>
		</div>
	</div>
</div>